AmbiverseNLU: A Natural Language Understanding suite by Max Planck Institute for Informatics combines a number of state-of-the-art components for language understanding tasks: named entity recognition and disambiguation (or entity linking), open information extraction, entity salience estimation, and concept linking. The Ambiverse project has ended, and the Max Planck Institute has graciously open-sourced the code. As Sense Collective works to build a knowledge commons and coordination layer for the decentralized web, we've found many of the best semantic web and knowledge representation tools and resources are from the first wave of these projects during the early 2000's. As more of these resources go offline or otherwise fall prey to broken links and a lack of resources, it is essential to aggregate these tools onto decentralized, distributed platforms designed to support the next 100 years. As part of Sense Collective's mission, we are in the process of demonstrating the effectiveness of various Web3.0 platforms for hosting these valuable resources. This is an example using the [Dat](https://datproject.org/) protocol and [Beaker Browser](https://beakerbrowser.com/).
